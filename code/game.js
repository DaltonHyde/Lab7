...
function Coin(pos) {
    this.basePos = this.pos = pos.plus(new Vector(0.2,0.1));//move the coins position
    this.size = new Vector(0.6, 0.6); //changes the size of the coin on the grid
